    ...
    _e = _e && _e.hasOwnProperty("default") ? _e["default"] : _e, Object.assign(_e.POPUP_TEMPLATES, {
        ...
        function E(e) {
            ...
            for (t = 0; t < a.length; t++)
                if (i.push(a[t].getAttribute("src")), d(a[t]).toggleClass("fr-draggable", g.opts.imageMove), "" === a[t].getAttribute("class") && a[t].removeAttribute("class"), "" === a[t].getAttribute("style") && a[t].removeAttribute("style"), a[t].parentNode && a[t].parentNode.parentNode && g.node.hasClass(a[t].parentNode.parentNode, "fr-img-caption")) {
                ...
                for (t = 0; t < o.length; t++) i.indexOf(o[t].getAttribute("src")) < 0 && g.events.trigger("image.removed", [d(o[t])]);
            if (o && e) {
                var s = [];
        ...
        function L(s, e, o, l, f) {
            ...
            t.onload = function() {
                ...
                if (l) {
                    ...
                    if (void 0 !== o)
                        for (t in o) o.hasOwnProperty(t) && "link" != t && e.attr("data-".concat(t), o[t]);
        ...
        function Y(e, t, a) {
            ...
            if (t && void 0 !== t)
                for (i in t) t.hasOwnProperty(i) && "link" != i && (" data-".concat(i, '="').concat(t[i], '"'), n.attr("data-str".concat(i), t[i]));
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                if (g.drag_support.formdata && (a = g.drag_support.formdata ? new FormData : null), a) {
                    ...
                    if (!1 !== g.opts.imageUploadToS3)
                        for (n in a.append("key", g.opts.imageUploadToS3.keyStart + (new Date).getTime() + "-" + (i.name || "untitled")), a.append("success_action_status", "201"), a.append("X-Requested-With", "xhr"), a.append("Content-Type", i.type), g.opts.imageUploadToS3.params) g.opts.imageUploadToS3.params.hasOwnProperty(n) && a.append(n, g.opts.imageUploadToS3.params[n]);
                    ...
                    g.opts.imageUploadToS3 && (r = g.opts.imageUploadToS3.uploadURL ? g.opts.imageUploadToS3.uploadURL : "https://".concat(g.opts.imageUploadToS3.region, ".amazonaws.com/").concat(g.opts.imageUploadToS3.bucket)),
                        function l(t, a, e, n) {
                            function r() {
                                var e = d(this);
            ...
            _init: function Ae() {
                ...
                (function e() {
                    ...
                    for (var e = 0; e < i.length; e++) {
                        var t = i[e].style.width || d(i[e]).width(),
