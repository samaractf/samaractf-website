...
! function (a) {
    ...
    if (b.DEFAULTS = {
            ...
            function h() {
                return a.$box ? (a.$box.append("<div style=\"position: absolute; bottom: 0px; left: 0px; z-index: 9999;\"><a href=\"https://froala.com/wysiwyg-editor\" style=\"padding: 3px 10px; display: inline-block; background-color: #D14841; color: #fff; text-decoration: none;\" target=\"_blank\">Unlicensed Froala Editor</a></div>"), j = a.$box.find("> div:last"), k = j.find("> a"), void("rtl" == a.opts.direction && j.css("left", "auto").css("right", 0))) : !1
            }

            function i() {
                var key= a.opts.key || [""];
                "string" == typeof key && (key = [c]), a.ul = !0;
                for (var d = 0; d < c.length; d++) {
                    var e = n(c[d]) || "";
                    if (!(e !== "OEM_LICENSE_KEY" && e.indexOf(m, e.length - m.length) < 0 && ["localhost", "127.0.0.1", "jshell.net", "fiddle.jshell.net"].indexOf(m) < 0)) {
                        a.ul = !1;
                        break
                    }
                }
            ...
            var j, k, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
                m = function () {
                    for (var a = 0, b = "127.0.0.1", key = b.split("."), d = "_gd" + (new Date).getTime(); a < c.length - 1 && -1 == document.cookie.indexOf(d + "=" + d);) b = c.slice(-1 - ++a).join("."), document.cookie = d + "=" + d + ";domain=" + b + ";";
            ...
            function h() {
                if (b.browser.mozilla && b.selection.isCollapsed() && !B) {
                    var a = b.selection.ranges(0),
                        key = a.startContainer,
                        d = a.startOffset;
                    key && c.nodeType == Node.TEXT_NODE && d <= c.textContent.length && d > 0 && 32 == c.textContent.charCodeAt(d - 1) && (b.selection.save(), b.spaces.normalize(), b.selection.restore())
                }
            }
            ...
            function f(c) {
                ...
                }).addClass("fr-disabled"), c.addClass("fr-active"), !b.helpers.isMobile() && b.opts.toolbarInline && b.toolbar.hide()
            }
            ...
            function k(c) {
                for (var d, e, f = 0; f < a.FE.INSTANCES.length; f++)
                    ...
                    var h = d;
                    if (d.parent().is("A") && (h = d.parent()), b.core.isEmpty()) b.$el.html(h);
                    else {
            ...
            function i() {
                ...
                b.events.on("keydown", function (c) {
                    ...
                    if (!(c.which >= 37 && c.which <= 40)) {
                        var g = d();
                        g && (g.getAttribute("class") || "").indexOf("fr-emoticon-img") && (a(g).append(a.FE.MARKERS), b.selection.restore())
                    }
                })
            }
            return {
            ...
            function x() {
                var a, c = Array.prototype.slice.call(b.$el.get(0).querySelectorAll("a.fr-file")),
                    d = [];
            ...
            function d() {
                i = a(b.o_win).scrollTop(), b.$box.toggleClass("fr-fullscreen"), a("body").toggleClass("fr-fullscreen"), j = a('<div style="display: none;"></div>'), b.$box.after(j), b.helpers.isMobile() && (b.$tb.data("parent", b.$tb.parent()), b.$tb.prependTo(b.$box), b.$tb.data("sticky-dummy") && b.$tb.after(b.$tb.data("sticky-dummy"))), k = b.opts.height, l = b.opts.heightMax, b.opts.height = b.o_win.innerHeight - (b.opts.toolbarInline ? 0 : b.$tb.outerHeight()), b.opts.heightMax = null, b.size.refresh(), b.opts.toolbarInline && b.toolbar.showInline();
            ...
            function r(a) {
                ...
                c && (c.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), c.find(".fr-image-progress-bar-layer").removeClass("fr-active"), c.find(".fr-buttons").show(), (a || b.$el.find("img.fr-error").length) && (b.events.focus(), b.$el.find("img.fr-error").length && (b.$el.find("img.fr-error").remove(), b.undo.saveStep(), b.undo.run(), b.undo.dropRedo())))
            }
            ...
            function K() {
                b.events.$on(b.$el, b._mousedown, "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function (c) {
                    return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") ? !0 : (b.helpers.isMobile() || b.selection.clear(), ua = !0, b.browser.msie && (b.events.disableBlur(), b.$el.attr("contenteditable", !1)), b.draggable || c.preventDefault(), void c.stopPropagation())
                }), b.events.$on(b.$el, b._mouseup, "IMG" == b.$el.get(0).tagName ? null : 'img:not([contenteditable="false"])', function (c) {
                    return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") ? !0 : void(ua && (ua = !1, c.stopPropagation(), b.browser.msie && (b.$el.attr("contenteditable", !0), b.events.enableBlur())))
                }), b.events.on("keyup", function (c) {
            ...
            function c() {
                A || h(), A.data("instance", b), A.show(), G.show(), A.data("current-image", b.image.get()), B || y(), i(), b.$doc.find("body").addClass("prevent-scroll"), b.helpers.isMobile() && b.$doc.find("body").addClass("fr-mobile")
            }
            ...
            function l(c) {
                ...
                }, d.src = c.thumb || c.url, m().append(e)
            }
            ...
            function r(c) {
                var e = a(c.currentTarget).siblings("img"),
                    f = A.data("instance") || b,
                    g = A.data("current-image");
                if (d(), f.image.showProgressBar(), g) g.data("fr-old-src", g.attr("src")), g.trigger("click");
                else {
                    f.events.focus(!0), f.selection.restore();
                    var h = f.position.getBoundingRect(),
                        i = h.left + h.width / 2,
                        j = h.top + h.height;
                    f.popups.setContainer("image.insert", f.$box || a("body")), f.popups.show("image.insert", i, j)
                }
                f.image.insert(e.data("url"), !1, q(e), g)
            }
            ...
            var A, B, C, D, E, F, G, H, I, J, K, L, M = 10,
                ...
                T = 22,
                U = {};
            return U[M] = "Image cannot be loaded from the passed link.", U[N] = "Error during load images request.", U[O] = "Missing imageManagerLoadURL option.", U[P] = "Parsing load response failed.", U[Q] = "Missing image thumb.", U[R] = "Missing image URL.", U[S] = "Error during delete image request.", U[T] = "Missing imageManagerDeleteURL option.", {
                require: ["image"],
                _init: z,
                show: c,
                hide: d
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function m() {
            return b.$wp ? (l(), o = !1, b.events.$on(b.$win, "mousemove", g), b.events.$on(a(b.win), "scroll", h), b.events.on("popups.show.table.edit", h), b.events.on("commands.after", h), b.events.$on(a(b.win), "mousedown", i), void b.events.$on(a(b.win), "mouseup", j)) : !1
        }
        var n, o, p;
        return {
            _init: m
        ...
        function c() {
            ...
            if (!c && b.$wp) {
                ...
                if (d && "A" === d.tagName) return d;
                var e = b.selection.element(),
                    f = b.selection.endElement();
                return "A" == e.tagName || b.node.isElement(e) || (e = a(e).parentsUntil(b.$el, "a:first").get(0)), "A" == f.tagName || b.node.isElement(f) || (f = a(f).parentsUntil(b.$el, "a:first").get(0)), f && f == e && "A" == f.tagName ? e : null
            }
        ...
        function r(f, g, h) {
            ...
            if (n) {
                ...
                for (var p in o) o.hasOwnProperty(p) && "class" != p && "style" != p && "id" != p && "contenteditable" != p && m.removeAttr(p);
        ...
        function n() {
            b.events.on("commands.after", m), b.events.on("keydown", function (c) {
                if (c.which == a.FE.KEYCODE.TAB) {
                    ...
                    if (e.length > 1 || e.length && b.selection.info(e[0]).atStart) return c.preventDefault(), c.stopPropagation(), c.shiftKey ? l(e) : k(e), !1
                }
            }, !0)
        }
        return {
        ...
        function c(c) {
            var d, e;
            d = c.offset().top - b.$box.offset().top - (k.outerHeight() - c.outerHeight()) / 2, e = 0 - k.outerWidth(), b.opts.iframe && (d += b.$iframe.offset().top - a(b.o_win).scrollTop()), k.hasClass("fr-on") && d > 0 && l.css("top", d), d > 0 && d < b.$box.outerHeight() - c.outerHeight() ? (k.hasClass("fr-hidden") && (k.hasClass("fr-on") && g(), k.removeClass("fr-hidden")), k.css("top", d)) : k.hasClass("fr-visible") && (k.addClass("fr-hidden"), h()), k.css("left", e)
        }
        ...
        function j() {
            return b.$wp ? (b.opts.iframe && b.$el.parent("html").find("head").append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css">'), b.popups.onShow("image.edit", f), b.events.on("mouseup", e), b.helpers.isMobile() && b.events.$on(a(b.o_doc), "selectionchange", e), b.events.on("blur", f), void b.events.on("keyup", e)) : !1
        }
        var k, l;
        return {
            _init: j,
        ...
        function p() {
            ...
            if (c.length > 0)
                ...
                else if (c.remove(), oa().length > 0) d();
            else {
                        ...
                        for (d = 0; d < g.length; d++)
                            if (0 === d || g[d][e] != g[d - 1][e])
                                if (f = a(g[d][e]), (parseInt(f.attr("colspan"), 10) || 1) > 1) {
                                    ...
                                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k), f.css("width", ((f.data("old-width") - ga(e, g)) * j / i).toFixed(4) + "%"), f.removeData("old-width")
                                } else {
        ...
        function y() {
            if (oa().length > 1 && (0 === b.$el.find("th.fr-selected-cell").length || 0 === b.$el.find("td.fr-selected-cell").length)) {
                var c, e, f = F(),
                    g = K(f),
        ...
        function F(b) {
            b = b || null;
            var c = [];
            return null == b && oa().length > 0 && (b = pa()), b ? (b.find("tr").not(b.find("table tr")).each(function (b, d) {
                var e = a(d),
                    f = 0;
        ...
        function Q(c) {
            var d = O(c);
            if (oa().length > 0 && !d && P(), !b.edit.isDisabled() || b.popups.isVisible("table.edit"))
                if (1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)(3 == c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey) && d && P();
                else if (ua = !0, d) {
                oa().length > 0 && !c.shiftKey && P(), c.stopPropagation(), b.events.trigger("image.hideResizer"), b.events.trigger("video.hideResizer"), ta = !0;
                var e = d.tagName.toLowerCase();
                c.shiftKey && b.$el.find(e + ".fr-selected-cell").length > 0 ? a(b.$el.find(e + ".fr-selected-cell").closest("table")).is(a(d).closest("table")) ? N(va, d) : J() : ((b.keys.ctrlKey(c) || c.shiftKey) && (oa().length > 1 || 0 === a(d).find(b.selection.element()).length && !a(d).is(b.selection.element())) && J(), va = d, N(va, va))
            }
        }

        function R(c) {
            if (ta || b.$tb.is(c.target) || b.$tb.is(a(c.target).closest(b.$tb.get(0))) || (oa().length > 0 && b.toolbar.enable(), I()), !(1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)) {
                if (ua = !1, ta) {
                    ta = !1;
                    var e = O(c);
                    e || 1 != oa().length ? oa().length > 0 && (b.selection.isCollapsed() ? d() : I()) : I()
                }
                if (xa) {
                    xa = !1, ra.removeClass("fr-moving"), b.$el.removeClass("fr-no-selection"), b.edit.on();
                    var f = parseFloat(ra.css("left")) + b.opts.tableResizerOffset;
                    b.opts.iframe && (f -= b.$iframe.offset().left), ra.data("release-position", f), ra.removeData("max-left"), ra.removeData("max-right"), fa(c), Z()
                }
            }
        }
        ...
        function S(c) {
            if (ta === !0) {
                var d = a(c.currentTarget);
                if (d.closest("table").is(pa())) {
                    if ("TD" == c.currentTarget.tagName && 0 === b.$el.find("th.fr-selected-cell").length) return void N(va, c.currentTarget);
                    if ("TH" == c.currentTarget.tagName && 0 === b.$el.find("td.fr-selected-cell").length) return void N(va, c.currentTarget)
                }
                J()
            }
        }
        ...
        function T(c, d) {
            for (var e = c; e && "TABLE" != e.tagName && e.parentNode != b.$el.get(0);) e = e.parentNode;
            if (e && "TABLE" == e.tagName) {
                var f = F(a(e));
                "up" == d ? V(G(c, f), e, f) : "down" == d && W(G(c, f), e, f)
            }
        }

        function U(a, c, d, e) {
            for (var f, g = c; g != b.$el.get(0) && "TD" != g.tagName && "TH" != g.tagName && ("up" == e ? f = g.previousElementSibling : "down" == e && (f = g.nextElementSibling), !f);) g = g.parentNode;
            "TD" == g.tagName || "TH" == g.tagName ? T(g, e) : f && ("up" == e && b.selection.setAtEnd(f), "down" == e && b.selection.setAtStart(f))
        }

        function V(a, c, d) {
            a.row > 0 ? b.selection.setAtEnd(d[a.row - 1][a.col]) : U(a, c, d, "up");
        }

        function W(a, c, d) {
            var e = parseInt(d[a.row][a.col].getAttribute("rowspan"), 10) || 1;
            a.row < d.length - e ? b.selection.setAtStart(d[a.row + e][a.col]) : U(a, c, d, "down")
        }

        function X(c) {
            var d = b.selection.blocks();
            if (d.length && (d = d[0], "TD" == d.tagName || "TH" == d.tagName)) {
                for (var e = d; e && "TABLE" != e.tagName && e.parentNode != b.$el.get(0);) e = e.parentNode;
                if (e && "TABLE" == e.tagName && (37 == c.which || 38 == c.which || 39 == c.which || 40 == c.which) && (oa().length > 0 && P(), b.browser.webkit && (38 == c.which || 40 == c.which))) {
                    c.preventDefault(), c.stopPropagation();
                    var f = F(a(e)),
                        g = G(d, f);
                    return 38 == c.which ? V(g, e, f) : 40 == c.which && W(g, e, f), b.selection.restore(), !1
                }
            }
        }

        function Y() {
            b.shared.$table_resizer || (b.shared.$table_resizer = a('<div class="fr-table-resizer"><div></div></div>')), ra = b.shared.$table_resizer, b.events.$on(ra, "mousedown", function (a) {
                return b.core.sameInstance(ra) ? (oa().length > 0 && P(), 1 == a.which ? (b.selection.save(), xa = !0, ra.addClass("fr-moving"), J(), b.edit.off(), ra.find("div").css("opacity", 1), !1) : void 0) : !0
            }), b.events.$on(ra, "mousemove", function (a) {
                return b.core.sameInstance(ra) ? void(xa && (b.opts.iframe && (a.pageX -= b.$iframe.offset().left), ia(a))) : !0
            }), b.events.on("shared.destroy", function () {
                ra.html("").removeData().remove(), ra = null
            }, !0), b.events.on("destroy", function () {
                b.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"), ra.hide().appendTo(a("body"))
            }, !0)
        }

        function Z() {
            ra && (ra.find("div").css("opacity", 0), ra.css("top", 0), ra.css("left", 0), ra.css("height", 0), ra.find("div").css("height", 0), ra.hide())
        }

        function $() {
            sa && sa.removeClass("fr-visible").css("left", "-9999px")
        }
        ...
        function _(c, d) {
            var e = a(d),
                f = e.closest("table"),
                g = f.parent();
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), !d || "TD" != d.tagName && "TH" != d.tagName) ra && e.get(0) != ra.get(0) && e.parent().get(0) != ra.get(0) && b.core.sameInstance(ra) && Z();
            else {
            ...
            if (0 === oa().length) {
                ...
                if (d && ("HTML" == d.tagName || "BODY" == d.tagName || b.node.isElement(d)))
                    for (e = 1; e <= b.opts.tableInsertHelperOffset; e++) {
                        ...
                        if (f && ("TH" == f.tagName || "TD" == f.tagName || "TABLE" == f.tagName) && (a(f).parents(".fr-wrapper").length || b.opts.iframe)) return aa(c, a(f).closest("table")), !0;
                        if (g = b.doc.elementFromPoint(c.pageX - b.win.pageXOffset + e, c.pageY - b.win.pageYOffset), a(g).hasClass("fr-tooltip")) return !0;
                        if (g && ("TH" == g.tagName || "TD" == g.tagName || "TABLE" == g.tagName) && (a(g).parents(".fr-wrapper").length || b.opts.iframe)) return ba(c, a(g).closest("table")), !0
                    }
                b.core.sameInstance(sa) && $()
            }
        }
        ...
        function da(a) {
            ...
            b.opts.tableResizer && (!b.popups.areVisible() || b.popups.areVisible() && b.popups.isVisible("table.edit")) && _(a, c), !b.opts.tableInsertHelper || b.popups.areVisible() || b.$tb.hasClass("fr-inline") && b.$tb.is(":visible") || ca(a, c)
        }
        ...
        function ea() {
            if (xa) {
                ...
                b.opts.iframe && (d += b.$iframe.offset().top - a(b.o_win).scrollTop()), ra.css("top", d)
            }
        }

        function fa() {
            var c = ra.data("origin"),
                d = ra.data("release-position");
            if (c !== d) {
                var e = ra.data("first"),
                    f = ra.data("second"),
                    g = ra.data("table"),
                ...
                if (null !== e && null !== f) {
                    ...
                    var r, s = g.parent(),
                        t = h / s.width() * 100;
                    null == e ? 0 === f ? (r = (h + d - c) / h * t, g.css("margin-right", "calc(100% - " + Math.round(r).toFixed(4) + "% - " + (parseInt(g.css("margin-left"), 10) || 0) + "px)")) : (r = (h - d + c) / h * t, g.css("margin-left", "calc(100% - " + Math.round(r).toFixed(4) + "% - " + (parseInt(g.css("margin-right"), 10) || 0) + "px)")) : 0 === e ? (r = (h - d + c) / h * t, g.css("margin-left", "calc(100% - " + Math.round(r).toFixed(4) + "% - " + (parseInt(g.css("margin-right"), 10) || 0) + "px)")) : (r = (h + d - c) / h * t, g.css("margin-right", "calc(100% - " + Math.round(r).toFixed(4) + "% - " + (parseInt(g.css("margin-left"), 10) || 0) + "px)")), g.css("width", Math.round(r).toFixed(4) + "%")
                }
                b.selection.restore(), b.undo.saveStep()
            }
            ra.removeData("origin"), ra.removeData("release-position"), ra.removeData("first"), ra.removeData("second"), ra.removeData("table")
        }
        ...
        function ha(a, b, c) {
            var d, e = 0;
            for (d = a; b >= d; d++) e += ga(d, c);
            return e
        }

        function ia(a) {
            if (oa().length > 1 && ua && J(), ua === !1 && ta === !1 && xa === !1) wa && clearTimeout(wa), (!b.edit.isDisabled() || b.popups.isVisible("table.edit")) && (wa = setTimeout(da, 30, a));
            else if (xa) {
                var c = a.pageX - b.win.pageXOffset;
                b.opts.iframe && (c += b.$iframe.offset().left);
                var d = ra.data("max-left"),
                    e = ra.data("max-right");
                c >= d && e >= c ? ra.css("left", c - b.opts.tableResizerOffset) : d > c && parseFloat(ra.css("left"), 10) > d - b.opts.tableResizerOffset ? ra.css("left", d - b.opts.tableResizerOffset) : c > e && parseFloat(ra.css("left"), 10) < e - b.opts.tableResizerOffset && ra.css("left", e - b.opts.tableResizerOffset)
            } else ua && $()
        }
        ...
        function ka(c) {
            ...
            if (d == a.FE.KEYCODE.TAB && 0 === b.opts.tabSpaces) {
                var e;
                if (oa().length > 0) e = b.$el.find(".fr-selected-cell:last");
                else {
                ...
                if (e) return c.preventDefault(), P(), c.shiftKey ? e.prev().length > 0 ? ja(e.prev()) : e.closest("tr").length > 0 && e.closest("tr").prev().length > 0 ? ja(e.closest("tr").prev().find("td:last")) : e.closest("tbody").length > 0 && e.closest("table").find("thead tr").length > 0 && ja(e.closest("table").find("thead tr th:last")) : e.next().length > 0 ? ja(e.next()) : e.closest("tr").length > 0 && e.closest("tr").next().length > 0 ? ja(e.closest("tr").next().find("td:first")) : e.closest("thead").length > 0 && e.closest("table").find("tbody tr").length > 0 ? ja(e.closest("table").find("tbody tr td:first")) : (e.addClass("fr-selected-cell"), q("below"), I(), ja(e.closest("tr").next().find("td:first"))), b.selection.restore(), !1
            }
        }
        ...
        function la() {
            b.shared.$ti_helper || (b.shared.$ti_helper = a('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabindex="-1" title="' + b.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), b.events.bindClick(b.shared.$ti_helper, "a", function () {
                var a = sa.data("selected-cell"),
                    c = sa.data("position"),
                    d = sa.data("instance") || b;
                ...
                $()
            }, !0)), sa = b.shared.$ti_helper, b.events.on("destroy", function () {
                sa = null
            }), b.tooltip.bind(b.$box, ".fr-insert-helper > a.fr-floating-btn")
        }

        function ma() {
            va = null, clearTimeout(wa)
        }

        function na() {
            oa().length > 0 ? d() : (b.popups.hide("table.insert"), b.toolbar.showInline())
        }
        ...
        function qa() {
            ...
            if (!b.helpers.isMobile()) {
                ua = !1, ta = !1, xa = !1, b.events.$on(b.$el, "mousedown", Q), b.popups.onShow("image.edit", function () {
                    I(), ua = !1, ta = !1
                }), b.popups.onShow("link.edit", function () {
                    I(), ua = !1, ta = !1
                }), b.events.on("commands.mousedown", function (a) {
                    a.parents(".fr-toolbar").length > 0 && I()
                }), b.events.$on(b.$el, "mouseenter", "th, td", S), b.events.$on(b.$win, "mouseup", R), b.opts.iframe && b.events.$on(a(b.o_win), "mouseup", R), b.events.$on(b.$el, "keydown", X), b.events.$on(b.$win, "mousemove", ia), b.events.$on(a(b.o_win), "scroll", ea), b.events.on("contentChanged", function () {
                    oa().length > 0 && (d(), b.$el.find("img").on("load.selected-cells", function () {
                        a(this).off("load.selected-cells"), oa().length > 0 && d()
                    }))
            ...
            b.events.on("keydown", ka), b.events.on("destroy", ma)
        }
        var ra, sa, ta, ua, va, wa, xa;
        return {
            _init: qa,
            insert: m,
            remove: n,
            ...
            d.each(function () {
                if ("IFRAME" != this.tagName)
                    if (3 == this.nodeType) {
                        ...
                        a.FE.URLRegEx.test(d) && (a(this).before(d.replace(a.FE.URLRegEx, "$1<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (b.opts.linkAlwaysNoFollow ? ' rel="nofollow"' : "") + ' href="$2">$2</a>$7')), a(this).remove())
        ...
        function d() {
            b.events.on("paste.afterCleanup", function (c) {
                return a.FE.URLRegEx.test(c) ? c.replace(a.FE.URLRegEx, "$1<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (b.opts.linkAlwaysNoFollow ? ' rel="nofollow"' : "") + ' href="$2">$2</a>$7') : void 0
        ...
        function e() {
            ...
            if (c || (c = y()), c) {
                b.popups.setContainer("video.edit", a(b.opts.scrollableContainer)), b.popups.refresh("video.edit");
